...
# class MultiStack_dynamic(MultiStack): # Not complete

    # class DynamicStack:
    #     def __init__(self, start, size, capacity):
    #         self.start = start
    #         self.size = size
...
if __name__ == "__main__":
    ...
    # print(newstack.pop(1)) # Should return error
    # print(newstack.peek(1)) # Should return error
    newstack.push(3, 1)
